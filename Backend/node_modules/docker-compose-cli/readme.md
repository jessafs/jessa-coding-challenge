...
const {dockerComposeTool} = require('docker-compose-cli');
...
const {before, after} = require('mocha');
const {dockerComposeTool, getAddressForService} = require('docker-compose-cli');
const pathToCompose = './docker-compose.yml';
...
the Docker Compose CLI will automatically scan all services available under your Compose yaml file
